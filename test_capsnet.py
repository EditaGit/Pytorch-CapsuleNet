...
if __name__ == '__main__':
    ...
    model = torch.load('test_model/checkpoint_epoch1')
    model.eval()

    test(model, mnist.test_loader)
    ...
    #     torch.save(capsule_net, 'test_model/checkpoint_epoch' + str(e))
